...
public class QrCodeCreateUtilWithLogo {
    ...
    public static BufferedImage drawLogoQRCode(File logoFile, String note, String qrUrl) {
    	System.out.println("QrCodeCreateUtilWithLogo.drawLogoQRCode:");
    	...
    	try {
            ...
            e.printStackTrace();
            System.out.println("QrCodeCreateUtilWithLogo.drawLogoQRCode: ERRORERRORERRORERRORERRORERRORERROR");
        }
    ...
    public static ByteArrayOutputStream encodeDrawLogoQRCode(File logoFile, String note, String qrUrl) throws IOException  {
    	System.out.println("QrCodeCreateUtilWithLogo.encodeDrawLogoQRCode");
